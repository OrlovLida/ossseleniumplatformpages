...
public class CreateMilestoneWithProcessTest extends BaseTestCase {
    ...
    public static final String PREDEFINED_MILESTONE_NAME = "Fixing Defects";
    ...
    @Test(priority = 1, description = "Create Process with Milestones")
    @Description("Create Process with Milestones")
    public void createProcessWithMilestones() {
        ...
        assertSystemMessage(String.format(PROCESS_CREATED_MESSAGE_PATTERN, processNameTC1, milestonesStepWizardPage.extractProcessCode()),
                SystemMessageContainer.MessageType.SUCCESS, String.format(INVALID_PROCESS_CREATION_MESSAGE, testName));
        ...
        String statusPredefinedMilestone = processOverviewPage.getMilestoneValue(PREDEFINED_MILESTONE_NAME, STATUS_LABEL);
        Assert.assertEquals(statusMilestone1, NEW_STATUS,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone1, STATUS_LABEL, testName));
        Assert.assertEquals(statusMilestone2, NOT_NEEDED_STATUS,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone2, STATUS_LABEL, testName));
        Assert.assertEquals(statusPredefinedMilestone, NEW_STATUS,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, PREDEFINED_MILESTONE_NAME, STATUS_LABEL, testName));
        ...
        String dueDatePredefinedMilestone = processOverviewPage.getMilestoneValue(PREDEFINED_MILESTONE_NAME, DUE_DATE_LABEL);
        Assert.assertEquals(dueDateMilestone1, LocalDate.now().plusDays(5).toString(),
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone1, DUE_DATE_LABEL, testName));
        Assert.assertEquals(dueDateMilestone2, "",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone2, DUE_DATE_LABEL, testName));
        Assert.assertEquals(dueDatePredefinedMilestone, LocalDate.now().plusDays(2).toString(),
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, PREDEFINED_MILESTONE_NAME, DUE_DATE_LABEL, testName));
        ...
        String completionDatePredefinedMilestone = processOverviewPage.getMilestoneValue(PREDEFINED_MILESTONE_NAME, COMPLETION_DATE_LABEL);
        Assert.assertEquals(completionDateMilestone1, LocalDate.now().toString(),
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone1, COMPLETION_DATE_LABEL, testName));
        Assert.assertEquals(completionDateMilestone2, "",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone2, COMPLETION_DATE_LABEL, testName));
        Assert.assertEquals(completionDatePredefinedMilestone,
                LocalDate.now().plusDays(2).toString(),
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, PREDEFINED_MILESTONE_NAME, COMPLETION_DATE_LABEL, testName));
        ...
        String relatedObjectPredefinedMilestone = processOverviewPage.getMilestoneValue(PREDEFINED_MILESTONE_NAME, RELATED_OBJECT_LABEL);
        Assert.assertEquals(relatedObjectMilestone1, PROCESS_LABEL,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone1, RELATED_OBJECT_LABEL, testName));
        Assert.assertEquals(relatedObjectMilestone2, TASK_LABEL + "(" + milestone2.getRelatedTask().get() + ")",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone2, RELATED_OBJECT_LABEL, testName));
        Assert.assertEquals(relatedObjectPredefinedMilestone,
                TASK_LABEL + "(" + FIRST_TASK_NAME + ")",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, PREDEFINED_MILESTONE_NAME, RELATED_OBJECT_LABEL, testName));
    }
    ...
    public void updatePredefinedMilestone() {
        ...
        Assert.assertEquals(statusMilestone3, NOT_NEEDED_STATUS,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone3, STATUS_LABEL, testName));
        ...
        Assert.assertEquals(dueDateMilestone3, "",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone3, DUE_DATE_LABEL, testName));
        ...
        Assert.assertEquals(completionDateMilestone3, "",
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone3, COMPLETION_DATE_LABEL, testName));
        ...
        Assert.assertEquals(relatedObjectMilestone3, PROCESS_LABEL,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone3, RELATED_OBJECT_LABEL, testName));
        ...
        Assert.assertEquals(descriptionMilestone1, UPDATE_DESCRIPTION_1,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone1, DESCRIPTION_LABEL, testName));
        Assert.assertEquals(descriptionMilestone2, UPDATE_DESCRIPTION_2,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone2, DESCRIPTION_LABEL, testName));
        Assert.assertEquals(descriptionMilestone3, UPDATE_DESCRIPTION_3,
                String.format(INVALID_MILESTONE_ATTRIBUTE_PATTERN, nameMilestone3, DESCRIPTION_LABEL, testName));
    }
