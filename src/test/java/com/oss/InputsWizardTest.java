...
public class InputsWizardTest extends BaseTestCase {
    ...
    public void testCheckbox() {
        Checkbox checkbox = (Checkbox) inputsWizardPage
                .getComponent(InputsWizardPage.CHECKBOX_ID);
    ...
    public void testCombobox() {
        Combobox combobox = (Combobox) inputsWizardPage
                .getComponent(InputsWizardPage.COMBOBOX_ID);
        ...
        combobox.clear();
        Assertions.assertThat(combobox.getStringValue()).isEmpty();
    ...
    public void testDateTime() {
        DateTime dateTime = (DateTime) inputsWizardPage
                .getComponent(InputsWizardPage.DATE_TIME_ID);
        ...
        Assertions.assertThat(dateTime.getStringValue()).isEmpty();
        dateTime.clear();
    ...
    public void testMultiCombobox() {
        MultiCombobox multiCombobox = (MultiCombobox) inputsWizardPage
                .getComponent(InputsWizardPage.MULTI_COMBOBOX_ID);
    ...
    public void testMultiSearchField() {
        MultiSearchField multiSearchField = (MultiSearchField) inputsWizardPage
                .getComponent(InputsWizardPage.MULTI_SEARCH_FIELD_ID);
    ...
    public void testNumberField() {
        NumberField numberField = (NumberField) inputsWizardPage
                .getComponent(InputsWizardPage.NUMBER_FIELD_ID);
        ...
        numberField.clear();
        Assertions.assertThat(numberField.getStringValue()).isEmpty();
    ...
    public void testPasswordField() {
        PasswordField passwordField = (PasswordField) inputsWizardPage
                .getComponent(InputsWizardPage.PASSWORD_FIELD_ID);
        ...
        passwordField.clear();
        Assertions.assertThat(passwordField.getStringValue()).isEmpty();
    ...
    public void testPhoneField() {
        PhoneField phoneField = (PhoneField) inputsWizardPage
                .getComponent(InputsWizardPage.PHONE_FIELD_ID);
        ...
        phoneField.clear();
        Assertions.assertThat(phoneField.getStringValue()).isEmpty();
    ...
    public void testSearchField() {
        SearchField searchField = (SearchField) inputsWizardPage
                .getComponent(InputsWizardPage.SEARCH_FIELD_ID);
    ...
    public void testSwitcher() {
        Switcher switcher = (Switcher) inputsWizardPage.getComponent(InputsWizardPage.SWITCHER_ID);
        // Switcher specific test cases
        switcher.setSingleStringValue("true");
        // Component tests
    ...
    public void testTextArea() {
        TextArea textArea = (TextArea) inputsWizardPage
                .getComponent(InputsWizardPage.TEXT_AREA_ID);
        ...
        textArea.clear();
        Assertions.assertThat(textArea.getStringValue()).isEmpty();
        // Component tests
    ...
    public void testTextField() {
        TextField textField = (TextField) inputsWizardPage
                .getComponent(InputsWizardPage.TEXT_FIELD_ID);
        ...
        textField.clear();
        Assertions.assertThat(textField.getStringValue()).isEmpty();
    ...
    private void testComponent(String componentId, Input input) {
        ...
        // Disabled until fix bug OSSWEB-19740
