...
public class FMSMDashboardTest extends BaseTestCase {
    private static final Logger log = LoggerFactory.getLogger(FMSMDashboardTest.class);
    ...
    public void checkMaximizeAndMinimize(
        ...
        String[] views = viewsForChosenDashboard.split(",");
        try {
    ...
    public void checkHeaders(
        ...
        String[] views_with_tables = viewsForChosenDashboard.split(",");
        try {
