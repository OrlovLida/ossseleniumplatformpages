...
import static com.oss.pages.iaa.servicedesk.ServiceDeskConstants.ISSUE_OUT_STATUS_ATTR;
...
public class TasksTest extends BaseTestCase {
    ...
    private com.oss.pages.iaa.servicedesk.issue.wizard.SDWizardPage SDWizardPage;
