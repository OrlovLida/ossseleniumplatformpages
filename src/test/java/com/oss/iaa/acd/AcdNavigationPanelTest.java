...
public class AcdNavigationPanelTest extends BaseTestCase {
    ...
    public void checkOverallInsightButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, OVERALL_INSIGHT_SUBCATEGORY);
    ...
    public void checkAsdSummaryButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ASD_SUMMARY_SUBCATEGORY);
    ...
    public void checkAbgadSummaryButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ABGAD_SUMMARY_SUBCATEGORY);
    ...
    public void checkApdSummaryButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, APD_SUMMARY_SUBCATEGORY);
    ...
    public void checkAsdSettingsButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ASD_SETTINGS_SUBCATEGORY);
    ...
    public void checkAbgadSettingsButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ABGAD_SETTINGS_SUBCATEGORY);
    ...
    public void checkApdSettingsButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, APD_SETTINGS_SUBCATEGORY);
    ...
    public void checkArSettingsButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, AR_SETTINGS_SUBCATEGORY);
    ...
    public void checkSystemSettingsButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, SYSTEM_SETTINGS_SUBCATEGORY);
    ...
    public void checkAsdAssessmentButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ASD_ASSESSMENT_SUBCATEGORY);
    ...
    public void checkAbgadAssessmentButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, ABGAD_ASSESSMENT_SUBCATEGORY);
    ...
    public void checkApdAssessmentButton() {
        navigationPanelPage.openApplicationInCategory(ACD_CATEGORY, APD_ASSESSMENT_SUBCATEGORY);
