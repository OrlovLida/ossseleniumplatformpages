...
public class RoleViewPage extends BasePage {
    ...
    private static final String ROLE_WIZARD_ID = "list-uid";
    private static final String CREATE_WIZARD_ID = "create-uid_prompt-card";
    private static final String EDIT_WIZARD_ID = "edit-uid_prompt-card";
    ...
    private static final String SUBMIT_BUTTON_ID = "wizard-submit-button-window-uid";
    ...
    public boolean doesRoleNameExist(String roleName) {
        return getCommonList().isRowDisplayedEquals(ATTRIBUTE_NAME, roleName);
    }
    ...
    private CommonList getCommonList() {
        return CommonList.create(driver, wait, ROLE_COMMON_LIST_DATA_ATTRIBUTE_NAME);
    }
