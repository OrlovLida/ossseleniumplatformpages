...
public class TemplateTreePage extends BasePage {
    ...
    private static final String TEMPLATE_APPLICATION_DELETE_FOLDER_ACTION_ID = "TemplateApplicationDeleteFolderActionId";
    ...
    @Step("Open template folder deletion popup")
    public void openTemplateFolderDeletionPopup() {
        templatesTree.callActionById(ActionsContainer.EDIT_GROUP_ID, TEMPLATE_APPLICATION_DELETE_FOLDER_ACTION_ID);
    }

    @Step("Select template folder: {folderName}")
