...
/**
 * @author Ewa Frączek If any method does not take extra tableId argument - it targets main table (upper).
 */
public class OldInventoryViewPage extends BasePage {
    ...
    public void getNumberOfRowsInTable(String tableTestId, String anyLabelExistingInTable) {
        createByComponentDataAttributeName(driver, wait, tableTestId);
    }
