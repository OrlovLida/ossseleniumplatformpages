...
public class FilterManagerPage extends BasePage {
    ...
    public FilterManagerPage editFolder(String name, String newName, String newDescription) {
        return openFolderWizard(name).typeNameOfTheFolder(newName).typeDescriptionOfTheFolder(newDescription).clickAccept();
    }
    ...
    public CreateFolderWizard openFolderWizard(String name) {
